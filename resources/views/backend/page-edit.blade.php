        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                        ...
                        <li>
                            <h4 class="page-title-main">Edit Page</h4>
                        </li>
                                ...
                                <div class="card">
                                    ...
                                    @include('backend.message')
                                        ...
                                        <form  action="{{url('admin/page/' . $page->id ) }}" method = "POST" enctype = "multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                <label for="permalink" class="form-label">Url :</label>
                                                <input type="text" class="form-control" value="{{$page->permalink}}" name="permalink" id="permalink" required="">
                                            </div>
                                              <div class="mb-3">
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input type="heading" id="heading" class="form-control" name="heading" value="{{$page->heading}}" data-parsley-trigger="change" required="">
                                              </div>

                                              <div class="mb-3">
                                                  <label for="subheading" class="form-label">Sub Heading :</label>
                                                  <input type="heading" id="heading" class="form-control" name="sub_heading" value="{{$page->sub_heading}}" data-parsley-trigger="change" required="">
                                              </div>

                                              <div class="mb-3">
                                              <label for="subheading" class="form-label">Content :</label>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <select id="heard" name ="status" class="form-select" required="">
                                                    @if($page->status)
