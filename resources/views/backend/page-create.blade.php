                                        ...
                                        <form  action="{{url('admin/page' ) }}" method = "POST" enctype = "multipart/form-data">
                                           ...
                                           <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="heading" class="form-control" name="heading" data-parsley-trigger="change" required="">
                                            </div>

                                            <div class="mb-3">
                                                <label for="subheading" class="form-label">Sub Heading :</label>
                                                <input type="text" id="sub_heading" class="form-control" name="sub_heading" data-parsley-trigger="change" required="">
                                            </div>
